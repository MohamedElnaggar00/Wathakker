...
fun DashboardScreen(viewModel: MainViewModel) {
    ...
    Column(
        ...
        if (currentOrPassedInstance != null) {
            ...
            DhikrHighlightCard(instance = currentOrPassedInstance, onMarkAsRead = { viewModel.markAsRead(currentOrPassedInstance.dhikr) })
        ...
        if (nextDhikrInstance != null) {
            ...
            DhikrHighlightCard(instance = nextDhikrInstance, onMarkAsRead = { viewModel.markAsRead(nextDhikrInstance.dhikr) })
        }
